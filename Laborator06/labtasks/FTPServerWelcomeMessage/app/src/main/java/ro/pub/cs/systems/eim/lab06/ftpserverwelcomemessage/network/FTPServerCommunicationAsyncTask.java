...
public class FTPServerCommunicationAsyncTask extends AsyncTask<String, String, Void> {
    ...
    protected Void doInBackground(String... params) {
        ...
        try {
            ...
            if(line.substring(0,4).equals(Constants.FTP_MULTILINE_START_CODE)) {
                ...
                line = br.readLine();
                while (!line.substring(0,3).equals(Constants.FTP_MULTILINE_END_CODE1)) {
    ...
    protected void onProgressUpdate(String... progres) {
        ...
        welcomeMessageTextView.setText(welcomeMessageTextView.getText().toString().concat(progres[0]));
    }
